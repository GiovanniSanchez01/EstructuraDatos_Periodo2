...
char ganadorDiagonal(char tablero[][LADO]);
...
int marcarCasillaJugador(char tablero[][LADO]){
	...
	imprimirTablero(tablero);
	return 1; //se devuelve 1 porque es el numero de casillas marcadas
}
...
char determinarGanador(char tablero[][LADO]){
	...
	if(ganador == 0)
		ganador = ganadorDiagonal(tablero);
